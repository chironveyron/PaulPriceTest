            ...
            {props.content1 ?? (
              <Fragment>
                <span className="testimonial17-text32">
                  ...
                  prices kept me on my toes, and I ended up making a huge
                  profit. Can&apos;t wait to play again!
                </span>
              </Fragment>
            )}
          </span>
                  ...
                  {props.review1 ?? (
                    <Fragment>
                      <span className="testimonial17-text34">
                        Such a fun concept! Investing in Pauls was addictive,
                        and the competition with my friends made it even more
                        exciting.
                      </span>
                    </Fragment>
                  )}
                  ...
                  <div className="testimonial17-container15">
                    ...
                    <span className="thq-body-small">
                      {props.author2Position ?? (
                        <Fragment>
                          <span className="testimonial17-text24">Gamer</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                  ...
                  {props.review2 ?? (
                    <Fragment>
                      <span className="testimonial17-text28">
                        I love the design of the game interface. It&apos;s
                        user-friendly and visually appealing. Count me in for
                        the next round of Pauls trading!
                      </span>
                    </Fragment>
                  )}
                </span>
                  ...
                  {props.review3 ?? (
                    <Fragment>
                      <span className="testimonial17-text36">
                        As a financial analyst, I appreciate the realism in the
                        stock market equation for Pauls. It&apos;s a great way
                  ...
                  {props.review4 ?? (
                    <Fragment>
                      <span className="testimonial17-text37">
                        The occasional crashes and spikes in Pauls&apos; prices
                        added an element of unpredictability that made the game
                        even more engaging. Highly recommended!
                      </span>
                    </Fragment>
                  )}
                </span>
