          ...
          >
            ...
            <div className="features24-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features24-text4">Invest in Pauls</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features24-text5">
                      Buy and sell Pauls in the PaulPrice stock market to try
                      and make a profit.
                    </span>
                  </Fragment>
                )}
                ...
                {props.feature2Description ?? (
                  <Fragment>
                    <span className="features24-text3">
                      Keep track of the number of Pauls you have invested and
                      the amount you have pocketed.
                    </span>
                  </Fragment>
                )}
              </span>
                ...
                {props.feature3Description ?? (
                  <Fragment>
                    <span className="features24-text1">
                      Compete with your friends to see who can make the most
                      Pauls by trading wisely.
                    </span>
                  </Fragment>
                )}
              </span>
...
Features24.defaultProps = {
  feature1ImgAlt: 'Invest in Pauls image',
  ...
  feature3ImgAlt: 'Compete with Friends image',
  ...
  feature2ImgAlt: 'Track Your Investments image',
