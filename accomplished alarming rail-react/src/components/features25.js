          ...
          >
            ...
            <div className="features25-content1">
              <h2 className="thq-heading-2">
                {props.feature1Title ?? (
                  <Fragment>
                    <span className="features25-text4">Buy and Sell Pauls</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.feature1Description ?? (
                  <Fragment>
                    <span className="features25-text2">
                      Invest in Pauls by buying and selling them in the
                      PaulPrice stock market.
                    </span>
                  </Fragment>
                )}
              </span>
          ...
          >
            ...
            <div className="features25-content2">
              <h2 className="thq-heading-2">
                {props.feature2Title ?? (
                  <Fragment>
                    <span className="features25-text3">Track Investments</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
          ...
          >
            ...
            <div className="features25-content3">
              <h2 className="thq-heading-2">
                {props.feature3Title ?? (
                  <Fragment>
                    <span className="features25-text6">Compete to Win</span>
                  </Fragment>
                )}
              </h2>
              <span className="thq-body-small">
                {props.feature3Description ?? (
                  <Fragment>
                    <span className="features25-text1">
                      Compete against friends to see who can make the most Pauls
...
Features25.defaultProps = {
  ...
  feature1ImgAlt: 'Buy and Sell Pauls Image',
  feature1Description: undefined,
  feature3ImgAlt: 'Compete to Win Image',
  ...
  feature2ImgAlt: 'Track Investments Image',
  feature2ImgSrc:
