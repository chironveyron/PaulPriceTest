          ...
          <div className="steps2-container3">
                ...
                {props.step1Description ?? (
                  <Fragment>
                    <span className="steps2-text25">
                      Create a username and password to register for the game
                      and start trading Pauls in the stock market.
                    </span>
                  </Fragment>
                )}
              </span>
            ...
            <div className="steps2-container5 thq-card">
              <h2 className="thq-heading-2">
                {props.step2Title ?? (
                  <Fragment>
                    <span className="steps2-text27">Buy and sell Pauls</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step2Description ?? (
                  <Fragment>
                    <span className="steps2-text28">
                      Use your virtual currency to purchase Pauls when the price
                      is low and sell them when the price is high to make a
                      profit.
                    </span>
                  </Fragment>
                )}
                ...
                {props.step3Description ?? (
                  <Fragment>
                    <span className="steps2-text26">
                      Monitor the number of Pauls you own, the current
                      PaulPrice, and the amount of profit you have made from
                      your trades.
                    </span>
                  </Fragment>
                )}
            ...
            <div className="steps2-container7 thq-card">
              <h2 className="thq-heading-2">
                {props.step4Title ?? (
                  <Fragment>
                    <span className="steps2-text32">Compete to win</span>
                  </Fragment>
                )}
              </h2>
                ...
                {props.step4Description ?? (
                  <Fragment>
                    <span className="steps2-text31">
                      Compete against your friends to see who can accumulate the
                      most Pauls and emerge as the top investor in the game.
                    </span>
                  </Fragment>
                )}
              </span>
